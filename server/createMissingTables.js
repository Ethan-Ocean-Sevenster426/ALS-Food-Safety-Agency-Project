...
async function run() {
  ...
  await pool.request().query(`
    ...
    CREATE TABLE EggProductionVerifications (
      ...
      PowderOpeningStock DECIMAL(18,2) DEFAULT 0,
      PowderPurchased DECIMAL(18,2) DEFAULT 0,
      PowderConverted DECIMAL(18,2) DEFAULT 0,
      PowderSoldToTrade DECIMAL(18,2) DEFAULT 0,
      PowderSoldToProducers DECIMAL(18,2) DEFAULT 0,
      PowderConversionLoss DECIMAL(18,2) DEFAULT 0,
      ...
      PowderPurchaseComment NVARCHAR(MAX),
